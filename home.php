        ...
        <ul class="splide__list">
          ...
          <?php foreach(getCarousel1() as $slide): ?>
            <li class="splide__slide">
              <img src="<?php echo $slide['slide_image_desctop']; ?>" alt="Slide 1" class="slide slide-desctop">
              <img src="<?php echo $slide['slide_image_mob']; ?>" alt="Slide 1" class="slide slide-mob">
              <div class="container">
